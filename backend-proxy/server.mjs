...
app.get('/fetchGames', async (req, res) => {
  ...
  try {
    ...
    const response = await axios({
      ...
      data: 'fields name,summary,cover.url,genres,platforms.name,screenshots.url,rating,release_dates.y; where platforms = 6 & release_dates.y > 2022 & rating != null; sort rating desc;'
    })
